...
export default function SignInCard() {
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center bg-white px-4 overflow-hidden">
      ...
      <div
        ...
        <div className="text-right mb-4">
          <a
            href="#"
            className="text-xs text-indigo-600 hover:underline hover:text-indigo-800 font-medium transition"
          >
            Forgot Password?
          </a>
        </div>
        ...
        <p className="text-sm text-center font-medium text-black">
          ...
          <span className="text-indigo-700 font-semibold cursor-pointer hover:underline hover:text-indigo-800 transition">
            Register
          </span>
        </p>
      </div>
